...
(function() {
  ...
  /* removed: var _$FuzzySearchStrategy_5 = require('./SearchStrategies/FuzzySearchStrategy') */ /* removed: var _$LiteralSearchStrategy_6 = require('./SearchStrategies/LiteralSearchStrategy') */ function NoSort() {
    return 0;
  }
  ...
  (function(window) {
    ...
    var options = {
      ...
      searchResultTemplate:
        '<li><a href="{url}"><button>{title}</button></a></li>',
    ...
    /* removed: var _$Templater_7 = require('./Templater') */ /* removed: var _$Repository_4 = require('./Repository') */ /* removed: var _$JSONLoader_2 = require('./JSONLoader') */ var optionsValidator = _$OptionsValidator_3(
      {
        required: requiredOptions
      }
    );
    /* removed: var _$utils_9 = require('./utils') */ window.SimpleJekyllSearch = function(
      _options
    ) {
